...
namespaces opengl opengl.gl opengl.capabilities opengl.shaders opengl.textures
sequences timers ui ui.gadgets ui.gadgets.worlds ui.pixel-formats ;
! To deploy the vocab add the following line and change path "vocab:5-sphere/1.jpg" to "./1.jpg" (and put 1.jpg to ./ after deploying)
