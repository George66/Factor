USING: accessors alien.c-types alien.data calendar combinators kernel math math.constants
math.matrices.simd math.vectors.simd multiline opengl opengl.gl opengl.capabilities
...
: (matrix) ( angle -- matrix )
     360.0 / 2 * pi *
     float-4{ 0.0 0.0 1.0 1.0 } swap rotation-matrix4 ;
