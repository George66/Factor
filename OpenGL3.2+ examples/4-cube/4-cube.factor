...
math.vectors.simd multiline opengl opengl.gl opengl.capabilities opengl.shaders
...
: (r-matrix) ( angle -- matrix )
     360.0 / 2 * pi *
     float-4{ 1.0 0.0 0.0 1.0 } swap rotation-matrix4 ;
